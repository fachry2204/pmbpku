...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .card { position: relative; width: 297.64px; height: 226.77px; padding: 12px 14px; overflow: hidden; border: 4px solid #064e3b; background: #fffdf8; }
        ...
        .header { padding-bottom: 13px; border-bottom: 2px solid #d4af37; }
        .logo { width: 92px; height: 28px; object-fit: contain; object-position: left center; }
        .heading { position: absolute; left: 120px; top: 14px; }
        .eyebrow { margin: 0 0 4px; color: #b18412; font-size: 9px; font-weight: bold; letter-spacing: 2px; }
        h1 { margin: 0; color: #064e3b; font-size: 13px; }
        .subtitle { margin: 4px 0 0; color: #55706a; font-size: 9px; }
        ...
        .schedule { float: right; width: 91px; min-height: 76px; padding: 7px; border: 1px solid #b7d7cb; border-radius: 5px; background: #f4faf7; }
        ...
        .attendance-qr img { float: left; width: 31px; height: 31px; margin-right: 4px; }
