    ...
    <section class="mx-auto max-w-4xl">
      ...
      <form @submit.prevent="submit" class="islamic-glass-card rounded-[28px] p-6 md:p-10">
        ...
        <section v-show="step===3">
          ...
          <div class="mt-6 rounded-xl bg-slate-50 p-5"><div class="flex justify-between text-sm"><span>Biaya pendaftaran</span><b>Dihitung oleh sistem</b></div><div class="mt-3 flex justify-between border-t pt-3 text-sm"><span>Biaya channel</span><b>Sesuai channel Duitku</b></div><p class="mt-4 text-xs leading-5 text-slate-500">Setelah data tersimpan, Anda akan masuk ke halaman konfirmasi pembayaran. Pembayaran tidak pernah dianggap lunas berdasarkan return URL browser.</p></div>
